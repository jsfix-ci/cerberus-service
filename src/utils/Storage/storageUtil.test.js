...
describe('StorageUtil', () => {
  ...
  it('should return the set task id', () => {
    ...
    const output = StorageUtil.getTaskStatus(LOCAL_STORAGE_KEYS.RORO_TASK_STATUS);
  ...
  it('should return stored data', () => {
    ...
    const storedData = StorageUtil.getItem(KEY);
  ...
  it('should return data item within stored data', () => {
    ...
    const storedDataItem = StorageUtil.getItem(KEY, 'alpha');
  ...
  it('should evaluate returned data to false if data item within stored data is not found', () => {
    ...
    const storedDataItem = StorageUtil.getItem(KEY, 'charlie');
