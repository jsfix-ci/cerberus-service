...
ENV KEYCLOAK_AUTH_URL=REPLACE_KEYCLOAK_AUTH_URL \
    ...
    FILE_UPLOAD_SERVICE_URL=REPLACE_FILE_UPLOAD_SERVICE_URL \
    REFDATA_API_URL=REPLACE_REFDATA_API_URL \
    COP_TARGETING_API_ENABLED=REPLACE_COP_TARGETING_API_ENABLED \
    RORO_V2_VIEW_ENABLED=REPLACE_RORO_V2_VIEW_ENABLED
